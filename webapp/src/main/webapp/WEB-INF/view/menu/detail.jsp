        ...
        <div class="content-box">
            ...
            <nav class="main-menu">
                ...
                <ul class="d:none md:d:flex">
                    <li><a class="icon icon-cart icon-color:base-0" href="/menu/list">장바구니</a></li>
...
추출된 풍부한 에스프레소와 신선한 우유가 어우러진 대표 라떼
                ...
                <div class="price-block heading-3 mt:2"><f:formatNumber>${menu.price}</f:formatNumber>원</div>
                <form>
                    ...
                    <fieldset class="quantity-block">
                        ...
                        <span class="ml:5"><span class="font-weight:bold"><f:formatNumber>${menu.price}</f:formatNumber></span>원</span>
                    </fieldset>
