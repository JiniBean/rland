                ...
                <section class="menu-card-list">
                    ...
                    <c:forEach items="${list}" var="m">
                        <section class="menu-card">
                            ...
                            <div class="price-block d:flex align-items:flex-end"><span class="font-weight:bold"><f:formatNumber>${m.price}</f:formatNumber></span>원<span class="soldout-msg ml:auto mr:auto md:d:none">SOLD OUT</span></div>
                            <div class="img-block">
                                <a href="detail?id=${m.id}"><img src="/image/menu/8.jpg"></a>
                            </div>
                            <c:choose>
                            	<c:when test="${m.like ==false}">
                            	...
                            	<c:otherwise>
		                            <div class="like-block d:flex justify-content:flex-end">
		                                <a class="icon icon-heart-fill" href="">좋아요</a>
		                                <span class="font-weight:bold ml:1"></span>
		                            </div>
                            	</c:otherwise>
                            </c:choose>
